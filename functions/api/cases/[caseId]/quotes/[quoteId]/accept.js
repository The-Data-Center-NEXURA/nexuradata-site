...
export const onRequestPost = async (context) => {
  try {
    ...
    const result = await setClientQuoteStatus(context.env, caseId, parsed.accessCode, quoteId, "approved");
    ...
    return json({ ok: false, message: error.message || "Approbation impossible." }, { status: 400 });
  }
};
