  ...
  return (
    <section className="bg-ink py-16 text-paper">
      <div className="section-shell">
        <p className="eyebrow text-amber">Process</p>
        <h2 className="mt-4 max-w-3xl text-3xl font-black md:text-4xl">Build the automation layer after the operating rules are visible.</h2>
